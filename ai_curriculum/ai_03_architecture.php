...
$next_link = 'ai_04_learning';
$next_text = 'Weiter: Wie lernt die Maschine?';
...
<div class="ai-card--notice mt-1 until-sm-display-none">
    <table class="c-black">
        <tr>
            <th>Modell</th>
            <th>
                <div class="c-black has-tooltip" data-tooltip='In der Welt der Neuronalen Netze sind Parameter die gewichteten Verbindungen (Weights) und die Schwellenwerte (Biases) innerhalb des Modells. Wenn wir von einem "70B Modell" sprechen, bedeutet das, dass das Modell aus 70 Milliarden Fließkommazahlen besteht, die während des Trainings optimiert wurden'>Geschätzte Parameter (Gesamt)</div>
            </th>
        ...
        <tr>
            ...
            <td>ca. 120</td>
            <td>
                <div class="c-black has-tooltip" data-tooltip='Hier wird das Modell in spezialisierte "Experten-Blöcke" unterteilt. Ein Token wie "Code" wird an den Experten für Programmierung geschickt, ein Token wie "Liebe" an den Experten für kreatives Schreiben.'>Mixture of Experts (MoE)</div>
            </td>
        </tr>
        <tr>
