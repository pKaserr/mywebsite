...
$next_link = 'ai_09_xai.php';
$next_text = 'Weiter: Vertrauen & Transparenz';
ob_start();
?>
...
<p>Die reine Textgenerierung ist nur noch das "Gehirn" in der Mitte. Drumherum baut sich ein
    ...
    simplen Chatbot zum autonomen Assistenten.
</p>
