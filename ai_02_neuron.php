...
<head>
    <title>AI 02: Das Atom des Netzes</title>
    ...
    <main>
        <div class="container_dashboard">
            ...
            <div class="container__title">
                <h4 class="container__title--text">02. Das Atom des Netzes: Vom Gehirn zur Matrix</h4>
                <span class="c-grey">Wie wir biologische Impulse in mathematische Funktionen übersetzen.</span>
            </div>
            ...
            <div class="panel">
                <div class="panel-content">
                    ...
                    <div class="ai-grid-2" style="margin-top: 2rem;">
                        ...
                        <div class="ai-card">
                            <div
                                style="text-align: center; margin-bottom: 1.5rem; min-height: 180px; display: flex; align-items: center; justify-content: center;">
                                <img src="assets/png/ann.png" style="max-width: 90%; "
                    ...
                    <p>Im Gehirn feuert ein Neuron oder es feuert nicht. Im künstlichen Netz regelt das die
                        ...
                        langweilige lineare Gleichung und könnte keine komplexen Probleme lösen.</p>
                    ...
                    <div class="code-box">
                        ...
                        <span class="c-keyword">+</span> ... <span class="c-keyword">+</span> <span
                            class="c-var">Bias</span>;<br>
                        <span class="c-var">output</span> <span class="c-keyword">=</span> <span
                            class="c-func">Aktivierungsfunktion</span>(<span class="c-var">summe</span>);
                    </div>
            ...
            <div style="display: flex; justify-content: space-between; margin-top: 2rem;">
                <a href="ai_01_big_picture.php"><button class="btn btn--main">&larr; Zurück</button></a>
                <a href="ai_03_architecture.php"><button class="btn btn--main">Weiter: Die Architektur (Layers)
                        &rarr;</button></a>
            </div>
        </div>
    </main>
