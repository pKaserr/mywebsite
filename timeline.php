...
<body>
   <nav>
      <div class="nav">
         <a href="logout"><button class="btn btn--main btn--nav" lang="de"
               data-translate="nav.logout">Abmelden</button></a>
         <a href="dashboard"><button class="btn btn--main btn--nav" lang="de"
               data-translate="nav.back">Zurück</button></a>
      </div>
   </nav>
   <main>
      ...
      <div class="container_dashboard">
         ...
         <p class="timeline-intro" lang="de" data-translate="timeline.intro">Mein Weg von der Logistik zur Informatik –
            ein umfassender Überblick über meine berufliche Entwicklung, Ausbildung und wichtige Meilensteine.</p>
      </div>
         ...
         <div class="timeline-section">
            ...
            <div class="timeline-item timeline-item--work">
               ...
               <div class="timeline-content">
                  ...
                  <p class="timeline-description">Echtzeitvisualisierung und -steuerung des Materialflusses, Prototyping
                     KI-gestützter Komponenten (z. B. Materialflussrechner), Mitarbeit an Forschungsprojekten.</p>
            ...
            <div class="timeline-item timeline-item--work">
               ...
               <div class="timeline-content">
                  ...
                  <p class="timeline-description">Schwerpunkt: Computer Vision, Deep Learning und wissenschaftliches
                     Arbeiten.</p>
                  <div class="timeline-highlights">
            ...
            <div class="timeline-item timeline-item--work">
               ...
               <div class="timeline-content">
                  ...
                  <h4>Hochschule Furtwangen</h4>
                  <p class="timeline-description">Lehre „Creative Coding“ für die Studiengänge Medienkonzeption Semester
                     1 und 2. Curriculumentwicklung, Inhaltserstellung, Prüfungen, Teamleitung.</p>
                  <div class="timeline-highlights">
            ...
            <div class="timeline-item timeline-item--work">
               ...
               <div class="timeline-content">
                  ...
                  <h4>Hochschule Furtwangen</h4>
                  <p class="timeline-description">Vorsitzender des allgemeinen Studierendenschaft (AstA), des
                     Studierendenrats und der verfassten Studierendenschaft. Leitung und Koordination, Vertretung der
                     Studierendenschaft, Entscheidngungsfindung und Strategieentwicklung, Konfliktmanagement, Förderung
                     von Studierendenbelangen und Teamführung</p>
                  <div class="timeline-highlights">
            ...
            <div class="timeline-item timeline-item--work">
               ...
               <div class="timeline-content">
                  ...
                  <h4>Hochschule Furtwangen</h4>
                  <p class="timeline-description">Fokus Webwareentwicklung, Projektmanagement, Netzwerke, Computergrafik
                     und Wirtschaft.</p>
                  <div class="timeline-highlights">
                     <span class="timeline-tag">Webentwicklung</span>
            ...
            <div class="timeline-item timeline-item--work">
               ...
               <div class="timeline-content">
                  ...
                  <p class="timeline-description">Leitung, Entwicklung & Projektmanagement (Scrum) in einem 6-köpfigen
                     Team.</p>
                  <div class="timeline-highlights">
