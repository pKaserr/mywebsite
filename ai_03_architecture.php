    ...
    <main>
        <div class="container_dashboard">
            ...
            <div class="panel">
                <div class="panel-content">
                    ...
                    <p>Ein einzelnes Neuron (wie unser Regenschirm-Entscheider) kann nur sehr simple
                        ...
                        neuronales Netz. <br> Diese neuronalen Netze haben unterschiedliche Schichten (Layer), die alle eine bestimmte Anzahl von Neuronen haben. Diese Schichten sind für eine bessere Darstellung zumeist nebeneinander angeordnet (von links nach rechts), oder untereinander (von oben nach unten).</p>
                    ...
                    <figcaption>Beispiel eines neuronalen Netzes, hier von einem Neural Radiance Field (beschreibung
                        unter meiner <a target="_blank" rel="noopener noreferrer" href="./experience#masterthesis">Masterthesis</a>). <br> Die
                        Eingabe (x, y, z, φ, θ) sind Koordinaten und Blickrichtung im 3D-Raum. Die Ausgabe (r, g, b,
                        σ) sind Farbe und Dichte an einer entspechenden Stelle im 3D-Raum. <br> Dieses neuronale Netz
                        hat einen Input-Layer mit 256 Neuronen (die vertikalen Punkte), sieben Hidden-Layer, ebenfalls
                        mit 256 Neuronen und einen Hidden-Layer mit 128 Neuronen. Ein einen Output mit RGB und Dichte.
                        Während die ersten acht Layer dafür zuständig sind die Density (Dichte, σ) zu berechnen, ist der
                        letzte Layer dafür zuständig die Farbe (RGB) zu berechnen. </figcaption>
                    ...
                    <div class="ai-flex-wrap" style="margin-top: 1.5rem;">
                        <div>
                            <p class="mt-2 c2-second">Schicht 1: Kanten</p>
                            <p>Die ersten Neuronen schauen nur auf
                                benachbarte Pixel und erkennen einfache Hell-Dunkel-Übergänge (vertikale oder
                                horizontale Linien). Da alle Daten digital sind und ein neuronales Netz nicht wie wir Farbunterschiede erkennen kann, müssen wir es die Farbunterschiede in Form von Zahlenwerten zuführen. So kann ein weißer Pixel mit dem Wert 255 und ein schwarzer Pixel mit dem Wert 0 dargestellt werden.</p>
                        </div>
                        <div>
                            <p class="mt-2 c2-second">Schicht 2: Formen</p>
                            <p>Die nächste Schicht kombiniert die
                                Kanten aus Schicht 1 zu geometrischen Formen (Kreise, Ecken, Kurven).</p>
                        </div>
                        <div>
                            <p class="mt-2 c2-second">Schicht 3: Merkmale</p>
                            <p>Aus den simplen Formen werden nun
                                komplexe Gesichtszüge zusammengesetzt (ein Auge, eine Nase, ein Ohr).</p>
                        </div>
                        <div>
                            <p class="mt-2 c2-second">Schicht 4: Das Objekt</p>
                    ...
                    <div>
                        ...
                        <p>Aus diesem Grund gibt es einen Ansatz, der sich <strong>XAI (Explainable
                            ...
                            <em>warum</em> das Netz eine bestimmte Entscheidung getroffen hat.</p>
                        ...
                        <div id="xai-module" class="ai-card--notice mt-1">
                            ...
                            <p>
                                Erinnere dich an das Regenschirm-Neuron aus <a class="c1-main" href="ai_02_neuron.php">Modul 02</a>.
                                Schalte die Eingaben ein oder aus und beobachte, wie ein XAI-Algorithmus die Entscheidung erklärt.
                            </p>
                            ...
                            <div class="xai-waterfall">
                                ...
                                <div class="xai-bar-row" style="opacity:.6">
                                    ...
                                    <div class="xai-bar-track"><span class="xai-bar-center"></span><span class="xai-bar-fill" id="xai-fill-b"></span></div>
                            ...
                            <p>
                                Bei der Bilderkennung (wie unserem Gesichts-Beispiel) macht XAI etwas Ähnliches <em>visuell</em>:
                                Es markiert genau die Pixel im Bild farbig, die für das Netz am wichtigsten waren, um das Gesicht zu erkennen.
            ...
            <div style="display: flex; justify-content: space-between; margin-top: 2rem;">
                ...
                <a href="ai_04_learning.php"><button class="btn btn--main">Weiter: Wie das Netz lernt (Backpropagation) &rarr;</button></a>
            </div>
        </div>
    </main>
