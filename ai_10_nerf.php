...
<head>
    <title>AI 10: Neural Radiance Fields (NeRF)</title>
    ...
    <main>
        <div class="container_dashboard">
            ...
            <div class="container__title">
                <h4>10. Der Sprung in den Raum: Neural Radiance Fields (NeRFs)</h4>
                <span class="c-grey">Von flachen Pixeln zu echten 3D-Welten durch volumetrisches
                    Rendering</span>
            </div>
            ...
            <div class="panel">
                <div class="panel-content">
                    ...
                    <p>Das Video zeigt ein selbsterstelltes NeRF, das zu eine Punktwolke wird. Dies war Teil meiner Masterthesis. Die Punktwolke wurde innerhalb des NeRFs erstellt, nicht davor.</p>
                </div>
            </div>


            <div class="mt-1" style="display: flex; justify-content: space-between;">
                <a href="ai_09_xai.php"><button class="btn btn--main">&larr; Zurück</button></a>
