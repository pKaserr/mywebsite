            ...
            <div class="container__title">
                ...
                <?php if ($is_guest) { ?>
                    <span data-translate="dashboard.intro_guest">Hier können Sie einen ersten Eindruck von meinen
                        Qualifikationen und Erfahrungen bekommen. Für weitere Informationen kontaktieren Sie mich gerne
                        direkt.</span>
                <?php } elseif ($initial_apply) { ?>
                    <span data-translate="dashboard.intro_individual">Schön, dass Sie hier her gefunden haben und meine
                        Initiativbewerbung bei Ihnen in Betracht ziehen.</span>
                <?php } else { ?>
                    <span data-translate="dashboard.intro_job" data-job="<?= htmlentities($job_desc) ?>">Schön, dass Sie
                        hier her gefunden haben und meine Bewerbung als <?= htmlentities($job_desc) ?> in Betracht
                        ziehen.</span>
                <?php } ?>
                <?php if (!$is_guest) { ?>
                    <span data-translate="dashboard.info_text">Unten finden Sie weitere Informationen über mich und die
                        Bewerbungsunterlagen sowie Zeugnisse und Empfehlungen als einzelnen Dokumente.</span>
                <?php } else { ?>
                    <span data-translate="dashboard.info_text_guest">Erkunden Sie die verfügbaren Bereiche um mehr über
                        meine Qualifikationen zu erfahren.</span>
                <?php } ?>
            </div>
                    ...
                    <a class="boxWrapper__a" href="about_me">
                        <div class="about-me-dashboard-icon">
                            <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <path d="M 30 75 Q 30 55 50 55 Q 70 55 70 75 L 70 85 L 30 85 Z" fill="#2e6c48"
                                    opacity="0.8" />

                                <!-- Skills/interests icons around the person -->
                                <!-- Computer/Tech (top left - red) -->
                                <circle cx="20" cy="20" r="5" fill="#d9534f" opacity="0.7" />
                                <rect x="16" y="16" width="8" height="8" rx="1" fill="none" stroke="#d9534f"
                                    stroke-width="1" />
                                ...
                                <rect x="78.5" y="34" width="3" height="2" fill="none" stroke="#f0ad4e"
                                    stroke-width="0.5" />

                                <!-- Code/Programming (bottom left - blue) -->
                                <circle cx="15" cy="60" r="5" fill="#0f7dbd" opacity="0.7" />
                                <path d="M 12 57 L 18 57 M 12 60 L 16 60 M 12 63 L 18 63" stroke="#0f7dbd"
                                    stroke-width="1" />
                        ...
                        <a class="boxWrapper__a" href="documents">
                            ...
                            <?php } else { ?>
                                <a class="boxWrapper__a boxWrapper__a--disabled">
                                    ...
                                    <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
                                        <!-- Main document -->
                                        <rect x="25" y="15" width="40" height="55" rx="3" fill="#0f7dbd"
                                            opacity="0.8" />
                                        ...
                                        <path d="M 13 25 L 15 27 L 17 23" stroke="#f0ad4e" stroke-width="1.2"
                                            fill="none" />

                                        <!-- PDF icon -->
                                        <circle cx="85" cy="35" r="6" fill="#d9534f" opacity="0.7" />
                                        <text x="85" y="38" text-anchor="middle" font-size="6" fill="#d9534f"
                                            font-weight="bold">P</text>

                                        <!-- Connection lines -->
                                        <line x1="21" y1="28" x2="28" y2="32" stroke="#e9ecef" stroke-width="1"
                                            opacity="0.4" />
                                        <line x1="79" y1="38" x2="72" y2="42" stroke="#e9ecef" stroke-width="1"
                                            opacity="0.4" />
                                    </svg>
                                    <span
                                        class="documents-dashboard-text documents-dashboard-text--disabled">Dokumente</span>
                                </div>
                            </a>
                            <a class="boxWrapper__a" href="experience">
                                <div class="experience-dashboard-icon">
                                    <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
                                        <!-- Briefcase/Portfolio -->
                                        <rect x="30" y="40" width="40" height="25" rx="3" fill="#2e6c48"
                                            opacity="0.8" />
                                        ...
                                        <path d="M 77 27 L 79 25 L 81 26 L 83 23" stroke="#d9534f" stroke-width="1.5"
                                            fill="none" />
                                        ...
                                        <!-- Connection lines -->
                                        <line x1="25" y1="28" x2="35" y2="38" stroke="#e9ecef" stroke-width="1"
                                            opacity="0.5" />
                                        <line x1="75" y1="28" x2="65" y2="38" stroke="#e9ecef" stroke-width="1"
                                            opacity="0.5" />
                                        <line x1="37" y1="58" x2="30" y2="65" stroke="#e9ecef" stroke-width="1"
                                            opacity="0.5" />
                                        <line x1="65" y1="58" x2="70" y2="65" stroke="#e9ecef" stroke-width="1"
                                            opacity="0.5" />
                                    </svg>
                            ...
                            <a class="boxWrapper__a" href="studium">
                                <div class="medieninformatik-dashboard-icon">
                                    <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <!-- Computer/Technology -->
                                        <rect x="35" y="55" width="30" height="20" rx="2" fill="#0f7dbd"
                                            opacity="0.8" />
                                        ...
                                        <!-- Camera (top left) -->
                                        <circle cx="20" cy="20" r="5" fill="#d9534f" opacity="0.7" />
                                        <rect x="17" y="17" width="6" height="6" rx="1" fill="none" stroke="#d9534f"
                                            stroke-width="1" />
                                        ...
                                        <rect x="82" y="67" width="6" height="6" rx="1" fill="none" stroke="#0f7dbd"
                                            stroke-width="0.8" />
                                        <path d="M 84 69 L 85 71 L 86 69" stroke="#0f7dbd" stroke-width="1"
                                            fill="none" />

                                        <!-- Connection lines -->
                                        <line x1="25" y1="22" x2="32" y2="30" stroke="#e9ecef" stroke-width="1"
                                            opacity="0.5" />
                                        <line x1="75" y1="22" x2="68" y2="30" stroke="#e9ecef" stroke-width="1"
                                            opacity="0.5" />
                                        <line x1="20" y1="65" x2="30" y2="62" stroke="#e9ecef" stroke-width="1"
                                            opacity="0.5" />
                                        <line x1="80" y1="65" x2="70" y2="62" stroke="#e9ecef" stroke-width="1"
                                            opacity="0.5" />
                                    </svg>
                                    <span class="medieninformatik-dashboard-text">Mein Studium</span>
                                </div>
                            </a>
                            <?php if (!$is_guest) { ?>
                                    ...
                                    <?php } else { ?>
                                        <a class="boxWrapper__a boxWrapper__a--disabled">
                                            ...
                                            <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <line x1="10" y1="20" x2="10" y2="80" stroke="#e9ecef"
                                                    stroke-width="2" />
                                                <rect x="20" y="17" width="70" height="6" rx="3" fill="#0f7dbd"
                                                    opacity="0.8" />
                                                <rect x="20" y="37" width="60" height="6" rx="3" fill="#2e6c48"
                                                    opacity="0.8" />
                                                <rect x="20" y="57" width="65" height="6" rx="3" fill="#d9534f"
                                                    opacity="0.8" />
                                                <rect x="20" y="77" width="55" height="6" rx="3" fill="#f0ad4e"
                                                    opacity="0.8" />
                                            </svg>
                            ...
                            <div class="boxWrapper__inner">
                                <a class="boxWrapper__a" href="add_comp">
                                    <div class="cover-note-dashboard-icon">
                                        <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
                                            <!-- Document -->
                                            <rect x="25" y="15" width="50" height="70" rx="3" fill="#f0ad4e"
                                                opacity="0.8" />
